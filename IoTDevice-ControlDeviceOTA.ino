...
////////////////////////////////////////////
// Features:                              //
// 1. Supports 1-2 relay modules attached //
// 2. Upgrade the firmware using OTA      //
// 3. Configurable loop & ping values     //
// 4. Seed Wifi configuration via Serial  //
////////////////////////////////////////////
// Connectivity:                          //
//  1. Relay 1: GND & D5                  //
//  2. Optional Relay 2: GND & D8 or D7   //
////////////////////////////////////////////
...
void loop() {
  ...
  loopCounter++;
  delay(loopWaitTime);//Wait x seconds before connect to the server again
}
